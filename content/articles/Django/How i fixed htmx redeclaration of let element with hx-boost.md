...
This type of scoping function doesn't work in all cases. For example, if you go to [search page](search.html){:data-cold} on this blog you can see that it's not enhanced. What gives ?
